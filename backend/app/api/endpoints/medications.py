...
from app.schemas import MedicationCreate, MedicationUpdate, MedicationInDB, MedicationWithDoses
...
def get_medications(
    ...
    for medication in medications:
        ...
        # Get last dose time
        last_dose = db.query(Dose).filter(
            Dose.medication_id == medication.id
        ).order_by(Dose.taken_at.desc()).first()
