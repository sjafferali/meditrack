...
const PersonManager: React.FC<PersonManagerProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed top-[160px] left-1/2 transform -translate-x-1/2 bg-white rounded-lg w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col shadow-xl z-[10000]">
